        ...
        resultText += `
            ...
            <div class="result_image" style="justify-content: center; align-items:center;">
             <img src="${lightingImg}" alt="${bestLighting}" class="oneimg"
                         style="width:500px; height:350px; object-fit:contain; margin-bottom:15px; border-radius:20px;">
              </div>  
      ...
      resultText += `
        ...
        <div class="result_image" style="justify-content: center; align-items:center;">
            <img src="${focalImg}" alt="${bestFocalPoint}" class="oneimg"
                 style="width:500px; height:350px; object-fit:cover; margin-bottom:15px; border-radius:20px;">
                 </div>
